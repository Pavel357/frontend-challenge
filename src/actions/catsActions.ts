import { ICatsList, CatsActionType, ICatsFetching, ICatsFetched, ICatsFetchingError, ICatsFetchedFavorites, ICatsClear, ICatDeleteFavorites } from "../types/catsType";
